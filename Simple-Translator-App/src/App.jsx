...
function App() {
  ...
  const handleSubmit = async (text, originLanguage, targetLanguage) => {
      ...
      <form onSubmit={handleSubmit}>
        <section className='translation_panels__container'>
          <div className="translation_origin__panel">
            ...
            <textarea name="to_translate_text" id="to_translate_text" placeholder='Escribe tu texto...' cols="30" rows="10" onChange={ev => setText(ev.target.value)}></textarea>
          </div>
